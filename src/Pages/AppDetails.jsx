...
const AppDetails = () => {
  ...
  const setInLocalStorage = () => {
    ...
    if (preSaveData) {
      let ifExist = preSaveData.some((savedId) => savedId == thisAppDetails.id);
      if (ifExist) {
        setIsClicked(true);
        return;
      }
      ...
      updateData = [thisAppDetails.id];
    }

    localStorage.setItem("installedApps", JSON.stringify(updateData));
    setIsClicked(true);
  };
